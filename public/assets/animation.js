...
// mainStage.clearRect(0,0,1920,1280);
// trailsStage.clearRect(0,0,1920,1280);
var can = document.getElementById('trails-canvas');
...
function update(frameTime, lag) {
    ...
    COLOR_CODES_W_INVIS.forEach(color => {
        ...
        // Sparks
        window.CP.exitedLoop(5); const sparks = Spark.active[color];
...
function render(speed) {
    ...
    window.CP.exitedLoop(8); trailsCtx.globalCompositeOperation = "lighten";
...
// const currentSkyColor = { r: 100, g: 100, b: 100 };
// const targetSkyColor = { r: 100, g: 100, b: 100 };
function colorSky(speed) {
    ...
    // targetSkyColor.r = 100;
    // targetSkyColor.g = 100;
    // targetSkyColor.b = 100;
